...
-- Criar tabela credito se não existir
...
) AS tmp(numero_credito, numero_nfse, data_constituicao, valor_issqn, tipo_credito, simples_nacional, aliquota, valor_faturado, valor_deducao, base_calculo)
WHERE NOT EXISTS (SELECT 1 FROM credito);
